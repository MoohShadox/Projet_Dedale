...
public class DummyCollectorAgent extends AbstractDedaleAgent{
	 ...
	 *<br/>
	 *
	 *  Rmq : This behaviour is in the same class as the DummyCollectorAgent for clarity reasons. You should prefer to save your Default.behaviours in the Default.behaviours package, and all the Default.behaviours referring to a given protocol in the same class
	 *	
	 *	@author hc
	 */
