...
import Default.dummies.DummyCollectorAgent;
import Default.dummies.DummyMovingAgent;
import eu.su.mas.dedale.mas.AbstractDedaleAgent;
import Default.dummies.ExploreSoloAgent;
...
//	
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, Simple_Cognitif_Agent.class.getName(), entityParametersExplo1);//
		agentList.add(ag);
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, Simple_Cognitif_Agent.class.getName(), entityParametersExplo2);//ExploreSoloAgent
